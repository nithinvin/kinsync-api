...
1. Create or target the feature folder: `./specs/`.
2. Generate or update the specification artifacts inside that folder:
   - `spec.md` (Requirements & acceptance criteria)
   - `plan.md` (Architecture, Design & execution strategy)
